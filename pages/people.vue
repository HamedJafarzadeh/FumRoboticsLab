  ...
  <div id="page-wrapper">
    <div class="content container">
      ...
      <div class="row text-center my-4">
        ...
        <div class="col-4"> <img src="../assets/people/aminian.png" style="width: 44%; border-radius: 20%">
          ...
          <h6>B.Sc. Mechanical Engineering, Shahid Rajaei Teacher Training University, Tehran, Iran, <br> (2004-2006)</h6>
      ...
      <div class="row text-center my-4">
        <div class="col-4">
          ...
          <h6>Ph.D. Mechanical Engineering, Ferdowsi University, Mashhad, Iran, <br> (2014-2019)</h6>
          <h6>M.Sc. Mechanical Engineering, Ferdowsi University, Mashhad, Iran, (2002-2004)</h6>

          <h6 >Research Interests/Specializations: Medical and Rehabilitation Robotics, Bio-Inspired Robot, Assistive control, Dynamic and Control Humanoid Robots, Assistive Devices </h6>

        </div>
        <div class="col-4"> <img src="../assets/people/khaniki.png" style="width: 239px; border-radius: 20%">
          <h5>Omid Khaniki</h5>
          ...
          <h6>Research Interests/Specializations: Optimization, Neuromusculoskeletal Modeling, Robotics, BioRobotics ,Rehabilitation, Artificial Intelligence, Digital Twin, Machine Design  </h6>
        </div>
        <div class="col-4"> <img src="../assets/people/mogharebi.png" style="width: 43%; border-radius: 20%">
          ...
          <h6>B.Sc. Mechanical Engineering, Science & Research Branch, Islamic Azad University, Tehran, Iran, <br> (2013-2017)</h6>
    ...
    <div class="col-4">
      ...
      <div class="row text-center my-4">
        ...
        <div class="col-4">
          ...
          <h6>Ph.D. Power Electronic & Electrical Machine Engineering, Ferdowsi University, Mashhad, Iran, <br> (2014/2020)</h6>
        ...
        <div class="col-4">
          ...
          <h6>M.Sc. Power Electronic and Electrical Machine Engineering, Ferdowsi university, Mashhad, Iran, <br> (2018/Present)</h6>
    ...
    <hr/>
      <div class="row text-center my-4">
        ...
        <div class="col-4">
          ...
          <h6>M.Sc. Power Electronic and Electrical Machine Engineering, Ferdowsi University, Mashhad, Iran <br> (2017-2020)</h6>
      ...
      <div class="row text-center my-4">
        ...
        <div class="col-4">
          ...
          <h6>M.Sc. Computer Network Engineering,Sajjad University of Technology, Mashhad, Iran, <br> (2018/present)</h6>
