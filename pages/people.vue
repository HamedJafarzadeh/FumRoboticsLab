<template>
  <div id="page-wrapper">
    <div class="content container">
      ...
      <div class="row text-center my-4">
        <Peopleitem img="alishiva.png" name="Ali Shiva"  grade="Postdoctoral Researcher"   email="foroudalishiva@yahoo.com" research=" Robotics, Soft Robotics, Dynamics,
        Multi Body Dynamics, Control
            Engineering, Morphological Computation" linkedin="https://www.linkedin.com/in/ali-shiva-83374882/" >
        </Peopleitem>

        <Peopleitem img="tahami.jpg" name="Seyyed Mohammad Tahamipour"  grade="Associate Researcher"   email="tahamipourzarandi@mail.um.ac.ir " research="  Robotics,
        ...
        <Peopleitem img="aminian.png" name="Ebrahim Aminian"  grade="Technical Manager"   email="ebrahimaminian_phd@yahoo.com" research=" Robotic Control,
      ...
      <div class="row text-center my-4">
        ...
        Bio-Inspired Robot, Assistive
            control, Dynamic and Control Humanoid Robots, Assistive Devices" linkedin="https://www.linkedin.com/in/samane-amini-a376ba52/" >
        </Peopleitem>

        <Peopleitem img="khaniki.png" name="Omid Khaniki"  grade="Ph.D Student"   email="Omid.Khaniki@mail.um.ac.ir " research="  Optimization, Neuromusculoskeletal Modeling,
        Robotics, BioRobotics
            ,Rehabilitation, Artificial Intelligence, Digital Twin, Machine Design" linkedin="https://www.linkedin.com/in/omid-khaniki/" >
        </Peopleitem>

        <Peopleitem img="mogharebi.png" name="Mostafa Moqarabi"  grade="Ph.D Student"   email="Mostafa.Mogharabi@gmail.com " research="  Robotic Control,
      ...
      <div class="row text-center my-4">
        ...
        <Peopleitem img="malekzade.jpg" name="Mohammad Malekzadeh Arasteh"  grade="Ph.D Student"   email="Mohammad.Malek132@gmail.com " research="  Humanoid Robotics,
        Legged Robotics, Continuous Passive Motion and Controlled Active Motion Devices" linkedin="" >
        </Peopleitem>

        <Peopleitem img="zare.png" name="Amir Hossein Zare"  grade="Ph.D Student"   email="amir.h.zare1991@gmail.com" research="  Machine Learning, Reinforcement Learning,
         Vision, Programming, Control, Advanced Robotics" linkedin="" >
        </Peopleitem>

        <Peopleitem img="rahman.png" name="Rahman Ardakanian"  grade="Ph.D Student"   email="rahman.ardakanian@mail.um.ac.ir " research="  Industrial and Medical Robots,
      ...
      <div class="row text-center my-4">
        ...
        <Peopleitem img="vaezi.png" name="Mohammad Rasool Vaezi"  grade="Ph.D Student"   email="mr_vaezi@mail.um.ac.ir " research="  Assistive Exoskeleton, Controlling Robots, Adaptive Control,
            Predictive Control , Advanced Control theory, Designing and Manufacturing Specialized Sensors" linkedin="" >
        </Peopleitem>

        <Peopleitem img="razavi.png" name="Seyyed Mohammadreza Razavi"  grade="Ph.D Student"   email="smreza_razavi@yahoo.com " research=" Optimal Control, Robust Control, State/Disturbance Observer, Adaptive
            Control" linkedin="" >
        </Peopleitem>

        <Peopleitem img="mosadegh.png" name="Hamidreza Mosaddegh Hesar"  grade="Associate Researcher"   email="hamid.mosaddegh@yahoo.com " research="  Variable-Speed AC Drives, Power Electronics, Electrical Machine
      ...
      <div class="row text-center my-4">
        ...
        <Peopleitem img="shahabi.png" name="Mohammad Entekhab Shahabi"  grade="M.Sc Student"   email="m.en.shahabi@gmail.com " research="  echanical Design, Robotics, Robot-Assisted Physiotherapy and Robotic
        ...
        <Peopleitem img="makhdoomi.png" name="Arian Makhdoomi"  grade="M.sc Student"   email="makhdumiaryan@gmail.com" research=" Electronic Circuit Design, Electrical Machine Design, Power
      ...
      <div class="row text-center my-4">
        ...
        <Peopleitem img="atashin.png" name="Soroush Ahooye Atashin"  grade="Associate Researcher"   email="s.atasheen@yahoo.com" research=" Control Drives,
        Power Electronics, Electrical Machine Design" linkedin="" >
        </Peopleitem>

        <Peopleitem img="forutan.png" name="Ali Forutanian"  grade="M.sc Student"   email="aliforoutanni@gmail.com" research=" Neuroimaging, Brain Connectivity,
        ...
        <Peopleitem img="maleki.png" name="Amirkhosro Maleki"  grade="M.sc Student"   email="maleki.amirkhosro@mail.um.ac.ir" research="  Artificial Intelligence Methods in Vital Signs Analysis for
            Controlling Rehabilitation Robots, Instrumentation Control and Automation, Medical Image processing" linkedin="" >
        </Peopleitem>
      ...
      <div class="row text-center my-4">
        ...
        <Peopleitem img="sabzali.png" name="Hojjat Sabzali"  grade="M.sc Student"   email="hsabzali@mail.um.ac.ir" research="  AExoskeleton robots, mechanical engineering design,
         FEM analysis and  control of series robots" linkedin="" >
        </Peopleitem>

        <Peopleitem img="soltani.png" name="Arezoo Soltani"  grade="M.sc Student"   email="Arezooslt49@gmail.com" research="  Neurorehabilitation, Biological Signal Processing, Artificial Neural
            Network" linkedin="" >
        </Peopleitem>

        <Peopleitem img="eskandari.png" name="Mohammad Hassan Eskandari"  grade="M.sc Student"   email="mmh_eskandari@outlook.com" research="  Serious Games, Human-Computer Interaction, Information
      ...
      <div class="row text-center my-4">
        ...
        <Peopleitem img="gholamian.png" name="Farzaneh Gholamian"  grade="Associate Researcher"   email="F_gholamian@sut.ac.ir" research=" Rehabilitation,
        Bone Biomechanics, Finite Element Analysis,
            Implants " linkedin="" >
        </Peopleitem>

        <Peopleitem img="tayarani.png" name="Keyvan Tayaranian Marvian"  grade="B.sc Student"   email="k.tayaranianmarvian@mail.um.ac.ir" research=" Control Theory, Rehabilitation Robotics, Machine Learning, and
            Computational Intelligence" linkedin="" >
        </Peopleitem>

        <Peopleitem img="salehi.png" name="Mostafa Salehi"  grade="M.sc Student"   email="mostafa73salehi@gmail.com" research="  Robotic Control,
      ...
      <div class="row text-center my-4">
        ...
        <Peopleitem img="kohandel.png" name="Reza Kohandel"  grade="M.sc Student"   email="rezakohandel9@gmail.com" research="  Medical Instruments, Microelectronics, Signal Processing" linkedin="" >
        </Peopleitem>

        <Peopleitem img="mohamadzade.png" name="Amir Mohammad Mohammad Zadeh"  grade="B.sc Student"   email="amirmohammad.m@hotmail.com" research="  Power Electronic, Electronic Circuit Designer,
Control Drive" linkedin="" >
        </Peopleitem>

        <Peopleitem img="Kazemi.png" name="Mahdi KazemiEsfahani"  grade="B.sc Student"   email="m.kazemiesfahani@mail.um.ac.ir" research="  Autonomous Robots, Human-Robot Interaction,
...
Energy Harvesting, AI" linkedin="" >
        ...
        <Peopleitem img="rezaei.png" name="Moein Rezaei"  grade="B.sc Student"   email="rezaei@UnboundGamestudio.com" research="  Gamification, Computer Graphics, Robotics,
 Game Development" linkedin="" >
        </Peopleitem>
